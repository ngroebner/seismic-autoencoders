...
# ?should incorporate the ground truth class labels - type of focal mechanism
# will need to load the dataframe with the info for this
...
def main(_run, data_dir, algorithm, skips, nnet_type,
    ...
    mech2cat = {'DC':0, 'CLVD':1, 'Isotropic':2}
    
    y = np.array([mech2cat[mechanism] for mechanism in synthetics['source_mechanisms']])
    ...
    for n_clusters in N_clusters:
        ...
        # TODO: add clusters, latent vectors, and final model weights as artifacts?
    ...
    for n,n_clust in enumerate(N_clusters):
        print('{}::{}'.format(n_clust, silhouette_scores[n]))
